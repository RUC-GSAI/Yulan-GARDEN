...
class EvaluationArguments:
    ...
    dataset_split: Optional[str] = field(
        default="test", metadata={"help": "split of evaluation datasets."}
    )
    content_column: Optional[str] = field(
        default="text", metadata={"help": "content column in evaluation datasets."}
    )
...
class InitializationArguments:
    ...
    config_name: Optional[str] = field(
        default="gpt2-small", metadata={"help": "Configuration to use for model initialization."}
    )
    tokenizer_name: Optional[str] = field(
        default="gpt2", metadata={"help": "Tokenizer attached to model."}
    )
    model_name: Optional[str] = field(default="gpt2-openwebtext2-small", metadata={"help": "Name of the created model."})